...
public class SortingBoxScript : MonoBehaviour {
    ...
    public void setDistances()
    {
        ...
        min_dist = elementArray[1].transform.position.x - elementArray[0].transform.position.x;

        max_dist = elementArray[elementArray.Length-1].transform.position.x - elementArray[0].transform.position.x;
    ...
    public float getOffsetY(GameObject go1, GameObject go2)
    {
        ...
        float distance = Mathf.Abs(go1.transform.position.x - go2.transform.position.x);
