...
public:
	...
	inline t3336811650 * fg0() const { return f0; }
	inline t3336811650 ** fag0() { return &f0; }
	inline void fs0(t3336811650 * value)
	{
		f0 = value;
	...
	inline t3336811650 * fg1() const { return f1; }
	inline t3336811650 ** fag1() { return &f1; }
	inline void fs1(t3336811650 * value)
	{
		f1 = value;
	...
	inline t273828612 * fg2() const { return f2; }
	inline t273828612 ** fag2() { return &f2; }
	inline void fs2(t273828612 * value)
	{
		f2 = value;
